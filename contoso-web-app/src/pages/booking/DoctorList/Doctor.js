          ...
          <Col className="doctor-info-column" xs={6} md={6} lg={5} >
            ...
            <Row className="doctor-info-row" >
              ...
              <i
                ...
                style={{ marginLeft: "36px", color:'white' }}
              ></i>
            ...
            <Row className="doctor-info-row">
              ...
              <div className="text-secondary doctor-info-text">
                <b style={{  color:'white'}}>Next available slot: </b>
